...
namespace Ishushx\Weather\Tests;

use Ishushx\Weather\Exceptions\InvalidArgumentException;
use Ishushx\Weather\Exceptions\HttpException;
use PHPUnit\Framework\TestCase;
use Ishushx\Weather\Weather;
...
class WeatherTest extends TestCase
{
    ...
    public function testGetWeatherWithInvalidType()
    {
        ...
        $this->expectExceptionMessage('Invalid response value(base/all):foo');
